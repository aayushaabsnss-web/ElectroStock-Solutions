...
// Alerts — static call, returns array of Alert objects
...
<div class="g2" style="margin-bottom:16px">
  ...
  <div class="card">
    ...
    <div style="display:flex;align-items:center;gap:10px;padding:9px 12px;background:var(--bg3);border-radius:8px;border-left:3px solid var(--amber)">
      <div style="flex:1">
        <div style="font-size:12px;font-weight:500"><?= h($al->getProductName()) ?></div>
        <div style="font-size:10px;color:var(--t2)"><?= $al->getCurrentQty() ?> left &middot; min <?= $al->getThreshold() ?></div>
      </div>
      <span class="badge b-red">-<?= $al->getShortfall() ?></span>
    </div>
